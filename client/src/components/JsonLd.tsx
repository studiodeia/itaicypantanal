...
export function buildLodgingBusiness() {
  ...
  return {
    ...
    address: {
      ...
      addressLocality: "Santo Antônio do Leverger",
      addressRegion: "MT",
      postalCode: "78180-000",
      addressCountry: "BR",
    },
    geo: {
      "@type": "GeoCoordinates",
    ...
    amenityFeature: [
      ...
      { "@type": "LocationFeatureSpecification", name: "Gastronomia pantaneira premium all-inclusive", value: true },
      { "@type": "LocationFeatureSpecification", name: "Retiro de descanso e desconexao digital na natureza", value: true },
    ],
    knowsAbout: [
      ...
      "Fauna e flora do Pantanal Norte Matogrossense",
      "Gastronomia pantaneira regional e culinaria tipica do Centro-Oeste",
      "Retiros de descanso e desconexao na natureza",
      "Hospedagem all-inclusive em ambiente natural",
      "Retiros corporativos e team building na natureza",
    ],
    audience: {
      "@type": "PeopleAudience",
      audienceType: "Pescadores esportivos, observadores de aves, ecoturistas, fotografos de natureza, casais, familias, executivos e profissionais buscando descanso na natureza, grupos corporativos em retiro, apreciadores de gastronomia regional, viajantes all-inclusive",
    },
    containedInPlace: {
      "@type": "TouristDestination",
      name: "Pantanal Norte Matogrossense",
...
export function buildOrganization() {
  ...
  return {
    ...
    foundingDate: "2024",
    description:
      "Eco lodge no Pantanal Norte Matogrossense especializado em pesca esportiva catch-and-release, observacao de aves e ecoturismo sustentavel.",
    address: {
      "@type": "PostalAddress",
      streetAddress: "Estrada Parque, s/n",
      addressLocality: "Santo Antônio do Leverger",
  ...
  return [
    {
      ...
      description:
        "Temporada de pesca esportiva catch-and-release no Pantanal Norte Matogrossense. Pintado, pacu, dourado e mais de 260 especies. Projeto Cota Zero — todo peixe devolvido vivo.",
