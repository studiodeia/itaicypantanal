...
type Props = { content: RegiaoPageContent["access"] };

export const AccessSection = ({ content }: Props): JSX.Element => {
  return (
            ...
            >
              <div className="flex items-center gap-3">
                <div className="flex items-center justify-center w-10 h-10 rounded-full bg-[rgba(172,128,66,0.15)]">
                  <Plane className="w-5 h-5 text-[#d7a45d]" strokeWidth={1.5} />
                </div>
