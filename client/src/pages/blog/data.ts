...
export const categorySlugMap: Record<string, string> = {
  Pesca: "pesca",
  "Observação de Aves": "observacao-de-aves",
...
export const featuredArticle: BlogArticle = {
  slug: "guia-observacao-aves-pantanal-especies-epocas-tecnicas",
  title:
    "Guia Completo de Observação de Aves no Pantanal: Espécies, Épocas e Técnicas",
  subtitle: "Observação de Aves",
  description:
    "Tudo o que você precisa saber para uma experiência de birdwatching inesquecível no Pantanal Norte-Matogrossense.",
  tag: "Observação de Aves",
  primaryCategory: "Observação de Aves",
  categories: ["Observação de Aves", "Conservação"],
  src: "/images/blog/birdwatching-pantanal-card.webp",
...
export const recentArticles: BlogArticle[] = [
  {
    slug: "guia-completo-pesca-esportiva-pantanal",
    title: "Guia Completo de Pesca Esportiva no Pantanal",
    subtitle: "Pesca",
    description:
      "Espécies, técnicas de pesca esportiva, melhores épocas e tudo o que você precisa saber para pescar no Pantanal Matogrossense.",
    tag: "Pesca",
    primaryCategory: "Pesca",
    categories: ["Pesca", "Aventura"],
    src: "/images/blog/pesca-esportiva-pantanal-card.webp",
    author: "Equipe Itaicy",
    date: "20 de Fevereiro, 2026",
    readingTime: "15 minutos de leitura",
  },
  {
    slug: "desconectar-para-reconectar-executivos-pantanal",
    title: "Desconectar para Reconectar: O Pantanal como Antídoto ao Burnout",
    subtitle: "Ecoturismo",
    description:
      "Como a natureza preservada do Pantanal Norte-Matogrossense pode ser a melhor estratégia de recuperação para profissionais de alta performance.",
    tag: "Ecoturismo",
    primaryCategory: "Ecoturismo",
    categories: ["Ecoturismo", "Gastronomia"],
    src: "/images/blog/executivos-pantanal-card.webp",
    author: "Equipe Itaicy",
    date: "20 de Fevereiro, 2026",
    readingTime: "8 minutos de leitura",
  },
  {
    slug: "gastronomia-all-inclusive-pantanal-descanso",
    title:
      "Gastronomia All-Inclusive no Pantanal: Uma Experiência para Todos os Sentidos",
    subtitle: "Gastronomia",
    description:
      "Como a culinária pantaneira premium, servida all-inclusive na Itaicy, se torna parte essencial de uma experiência de descanso e reconexão.",
    tag: "Gastronomia",
    primaryCategory: "Gastronomia",
    categories: ["Gastronomia", "Ecoturismo"],
    src: "/images/blog/gastronomia-pantanal-card.webp",
    author: "Equipe Itaicy",
    date: "20 de Fevereiro, 2026",
...
export const allArticles: BlogArticle[] = [
  {
    ...
    title:
      "Guia Completo de Observação de Aves no Pantanal: Espécies, Épocas e Técnicas",
    subtitle: "12 minutos de leitura",
    tag: "Observação de Aves",
    primaryCategory: "Observação de Aves",
    categories: ["Observação de Aves", "Conservação"],
    src: "/images/blog/birdwatching-pantanal-card.webp",
  ...
  {
    slug: "acordar-som-passaros-birdwatching-pantanal",
    title: "Acordar com o Som dos Pássaros: A Experiência de Birdwatching na Itaicy",
    subtitle: "6 minutos de leitura",
    tag: "Observação de Aves",
    primaryCategory: "Observação de Aves",
    categories: ["Observação de Aves"],
    src: "/images/blog/acordar-passaros-pantanal-card.webp",
    author: "Equipe Itaicy",
    date: "20 de Fevereiro, 2026",
