...
export const AccommodationInfoSection = ({ content }: Props): JSX.Element => {
  return (
    <section
      ...
      style={{
        backgroundImage: `linear-gradient(270deg,rgba(21,34,24,0)_0%,rgba(21,34,24,0.64)_100%), linear-gradient(0deg,rgba(0,0,0,0.32)_0%,rgba(0,0,0,0.32)_100%), url(${content.backgroundImage})`,
      }}
    >
