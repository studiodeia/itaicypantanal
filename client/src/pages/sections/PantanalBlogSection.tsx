    ...
    <section className="flex flex-col items-center justify-end gap-8 w-full bg-[#263a30]">
      <div className="flex flex-col max-w-[1440px] items-center justify-end gap-10 md:gap-16 lg:gap-[100px] px-4 md:px-8 lg:px-16 py-12 md:py-16 lg:py-[100px] w-full">
        <header className="flex flex-col items-start gap-6 md:gap-8 w-full">
          <div className="flex items-center justify-center w-full font-lead-md font-[number:var(--lead-md-font-weight)] text-[#a8cab9] text-[length:var(--lead-md-font-size)] tracking-[var(--lead-md-letter-spacing)] leading-[var(--lead-md-line-height)] [font-style:var(--lead-md-font-style)]" data-testid="text-blog-label">
            BLOG
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8 w-full">
          {blogPosts.map((post) => (
            <Card
              key={post.id}
              className="flex-col items-start rounded-lg overflow-hidden flex bg-transparent border-0"
            ...
            >
              ...
              <CardContent className="flex flex-col gap-3 md:gap-4 pt-4 pb-0 px-0 w-full">
                ...
                <h3 className="font-heading-md font-[number:var(--heading-md-font-weight)] text-[#e3f7ec] text-[length:var(--heading-md-font-size)] tracking-[var(--heading-md-letter-spacing)] leading-[var(--heading-md-line-height)] w-full [font-style:var(--heading-md-font-style)]">
                  {post.title}
                </h3>
