  ...
  return (
    <section className="flex flex-col items-center justify-center w-full bg-[#fcf4ed]">
      <div className="flex flex-col lg:flex-row max-w-[1440px] items-center gap-12 md:gap-16 lg:gap-[100px] px-5 md:px-8 lg:px-16 py-12 md:py-16 lg:py-[100px] w-full">
        <motion.div variants={scaleIn} initial="hidden" whileInView="visible" viewport={viewport} className="w-full lg:flex-1 lg:max-w-[780px] h-[464px] md:min-h-[400px] lg:h-[816px] bg-[url(/images/home/impact.webp)] bg-cover bg-center rounded-lg" data-testid="img-impact" />
