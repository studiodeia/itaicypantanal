...
export const ImmersionCallToActionSection = (): JSX.Element => {
  return (
    <section className="items-center flex-[0_0_auto] z-[1] bg-[linear-gradient(0deg,rgba(0,0,0,0.5)_0%,rgba(0,0,0,0.5)_100%),url(..//figmaAssets/section---cta.png)_50%_50%_/_cover] flex flex-col relative w-full">
      <div className="flex flex-col max-w-[1440px] min-h-[600px] md:min-h-[800px] lg:min-h-[1000px] items-start justify-between px-4 md:px-8 lg:px-16 py-12 md:py-16 lg:py-[100px] relative w-full">
        ...
        <div className="flex flex-col w-full md:max-w-[520px] lg:max-w-[592px] items-start gap-8 md:gap-10 lg:gap-12 relative mt-8 md:mt-0">
          <p className="relative self-stretch font-body-lg font-[number:var(--body-lg-font-weight)] text-[#e3f7ec] text-[length:var(--body-lg-font-size)] tracking-[var(--body-lg-letter-spacing)] leading-[var(--body-lg-line-height)] [font-style:var(--body-lg-font-style)]">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-between gap-3 sm:gap-0 pl-3 md:pl-5 pr-2 py-2 relative self-stretch w-full bg-[#0a130b33] rounded-lg backdrop-blur-[2.0px] backdrop-brightness-[110%] [-webkit-backdrop-filter:blur(2.0px)_brightness(110%)] shadow-[inset_0_1px_0_rgba(255,255,255,0.40),inset_1px_0_0_rgba(255,255,255,0.32),inset_0_-1px_1px_rgba(0,0,0,0.13),inset_-1px_0_1px_rgba(0,0,0,0.11)]">
            ...
            <Button className="inline-flex items-center justify-center gap-2 px-3 md:px-4 py-1.5 relative bg-[#ac8042] rounded h-auto" data-testid="button-buscar-datas-cta">
