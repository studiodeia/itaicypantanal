...
export const ImmersionCallToActionSection = (): JSX.Element => {
  return (
    <section className="items-center flex-[0_0_auto] z-[1] bg-[linear-gradient(0deg,rgba(0,0,0,0.5)_0%,rgba(0,0,0,0.5)_100%),url(..//figmaAssets/section---cta.png)_50%_50%_/_cover] flex flex-col relative w-full">
      <div className="flex flex-col max-w-[1440px] h-[844px] md:min-h-[800px] md:h-auto lg:h-[1000px] items-start justify-between px-5 md:px-8 lg:px-10 py-12 md:py-16 lg:py-[100px] relative w-full">
        ...
        <div className="flex flex-col w-full md:max-w-[520px] lg:max-w-[592px] items-start gap-8 md:gap-10 lg:gap-[48px] relative mt-8 md:mt-0">
