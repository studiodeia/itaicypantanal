...
export const PantanalExperienceIntroSection = (): JSX.Element => {
  ...
  return (
    <section className="flex flex-col items-center justify-center bg-[#263a30] w-full relative z-10">
      <div className="flex flex-col max-w-[1440px] items-center gap-[100px] px-16 py-[100px] w-full">
        <div className="flex flex-col items-start gap-8 w-full">
          <p className="flex items-center justify-center w-full font-lead-md font-[number:var(--lead-md-font-weight)] text-[#a8cab9] text-[length:var(--lead-md-font-size)] tracking-[var(--lead-md-letter-spacing)] leading-[var(--lead-md-line-height)] [font-style:var(--lead-md-font-style)]">
            MANIFESTO
          </p>

          <h1 className="flex items-center justify-center w-full [font-family:'Playfair_Display',Helvetica] font-normal text-transparent text-[64px] tracking-[0] leading-[64px]">
          ...
          <Button
            variant="ghost"
            className="flex items-center justify-between gap-4 px-0 py-4 w-full h-auto border-b border-solid border-[#f2fcf7] rounded-none hover:bg-transparent"
          >
