  ...
  faq: {
    ...
    items: [
      ...
      },
      {
        ...
        answer: "A Itaicy está localizada no município de Miranda, no Mato Grosso do Sul, uma região estratégica que conecta o Pantanal a outros destinos turísticos do estado. A distância até Campo Grande, capital do estado, é de aproximadamente 240 km, percorridos em cerca de três horas pela rodovia BR-262, inteiramente asfaltada. Para quem vem de Bonito, são apenas 80 km, ou cerca de uma hora e meia de viagem. O aeroporto mais próximo é o Aeroporto Internacional de Campo Grande (CGR), que recebe voos diretos de São Paulo, Brasília e outras capitais. A partir do aeroporto, oferecemos serviço de transfer rodoviário sob consulta prévia, com horários coordenados aos voos. A estrada de acesso é pavimentada até a entrada da propriedade, o que torna a chegada confortável em qualquer época do ano, inclusive durante o período de chuvas.",
      },
    ],
  },
};
