  ...
  faq: {
    ...
    items: [
      ...
      },
      {
        ...
        answer: "La procedencia de los ingredientes es uno de los pilares de nuestra propuesta gastronómica, porque creemos que un plato excepcional comienza mucho antes de la preparación — en la selección cuidadosa de la materia prima y en el respeto a la cadena productiva local que sostiene la región. Priorizamos ingredientes regionales y estacionales en todas las comidas servidas en el lodge. Las carnes bovinas provienen de estancias de la región de Santo Antônio do Leverger y el entorno pantanero con certificación de buenas prácticas de manejo. Las hierbas frescas como cebollín, perejil, albahaca y ají dulce se cosechan diariamente de nuestro propio huerto orgánico mantenido por el equipo del lodge. Las frutas nativas como bocaiuva y guavira provienen de recolectores comunitarios de la región. Esta rigurosa trazabilidad garantiza frescura máxima, calidad constante en cada plato y genera un impacto económico positivo y directo en las familias de la comunidad local.",
      },
      {
        id: "culinaria-5",
        number: "05",
