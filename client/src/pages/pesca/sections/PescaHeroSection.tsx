...
export const PescaHeroSection = (): JSX.Element => {
  ...
  return (
    <section className="relative flex flex-col h-[844px] md:h-[680px] lg:h-[920px] items-center justify-end w-full z-[11] overflow-hidden">
      ...
      <img
        ...
        data-testid="img-pesca-hero-background"
      />
      ...
      >
        <div className="flex flex-col items-start gap-6 md:gap-8 w-full max-w-[738px]">
          ...
          <motion.h1
            ...
            data-testid="text-pesca-hero-heading"
            variants={fadeUp}
          >
            Pesca Esportiva de Alta Performance em Zonas Exclusivas
          </motion.h1>
        </div>
        ...
        <motion.div className="flex flex-col gap-6 md:gap-8 w-full" variants={fadeUp}>
          ...
          <div className="flex items-start justify-between w-full">
            <p
              ...
              data-testid="text-pesca-subtitle"
            >
              Uma operação de pesca esportiva de alto nível. Navegue por rios de
              acesso exclusivo, onde a pressão de pesca é mínima e os gigantes
              do Pantanal ainda reinam.
            </p>
