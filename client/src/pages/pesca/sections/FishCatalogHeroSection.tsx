...
export const FishCatalogHeroSection = (): JSX.Element => {
    ...
    <section className="relative flex flex-col h-[844px] md:h-[680px] lg:h-[920px] items-center justify-end w-full z-[11] overflow-hidden">
      ...
      <div
        className={`absolute inset-0 transition-all duration-300 ${
          menuOpen ? "z-[3] glass-overlay-hero" : "z-[1]"
        }`}
        style={
          !menuOpen
            ? {
        ...
        <motion.div className="flex flex-col gap-6 md:gap-8 w-full" variants={fadeUp}>
          ...
          <div className="flex items-start justify-between w-full">
            <motion.p className="max-w-[600px] font-body-md font-[number:var(--body-md-font-weight)] text-[#e3f7ec] text-[length:var(--body-md-font-size)] leading-[var(--body-md-line-height)] tracking-[var(--body-md-letter-spacing)] [font-style:var(--body-md-font-style)]" variants={fadeUp}>
              Conheça as espécies que habitam nossas águas. Perfis completos com
              hábitos, tamanho, melhor época e dicas de pesca para cada espécie.
            </motion.p>
