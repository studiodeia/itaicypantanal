...
export const CulinaryHighlightsSection = (): JSX.Element => {
  return (
    <section className="flex flex-col items-center w-full bg-[#344e41]">
      <div className="flex flex-col max-w-[1440px] items-center gap-12 md:gap-16 lg:gap-[100px] px-5 md:px-8 lg:px-16 py-12 md:py-16 lg:py-[100px] w-full">
        ...
        <motion.h2
          ...
          data-testid="text-culinary-highlights-heading"
          variants={fadeUp}
          initial="hidden"
          whileInView="visible"
          viewport={viewport}
        >
          Do Rio e da Horta à Sua Mesa
        </motion.h2>
        ...
        >
          {highlights.map((item, index) => (
            <motion.div
              ...
              data-testid={`card-culinary-highlight-${index}`}
              variants={cardItem}
            >
              <item.icon
