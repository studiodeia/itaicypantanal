    ...
    items: [
      {
        ...
        answer: "O Pantanal é reconhecido internacionalmente como um dos maiores santuários de aves do planeta, abrigando mais de 650 espécies catalogadas ao longo de décadas de pesquisa ornitológica em todo o bioma. Nosso levantamento científico conduzido pelo ornitólogo João Andriola em maio de 2024 registrou 166 espécies distintas no entorno imediato do lodge em apenas 5 dias de expedição sistemática, o que demonstra a densidade excepcional de avifauna nesta área. A região de Santo Antônio do Leverger, onde a Itaicy está localizada, é considerada um dos pontos de maior concentração de aves do Pantanal Norte devido à convergência de habitats variados como matas ciliares, campos inundáveis, baías e corixos. Dependendo da estação, esse número pode aumentar com a chegada de espécies migratórias do hemisfério norte entre outubro e dezembro, elevando ainda mais a riqueza e diversidade observável durante sua estadia.",
      },
      {
        id: "bird-2",
        number: "02",
    ...
    items: [
      {
        ...
        answer: "The Pantanal is internationally recognized as one of the greatest bird sanctuaries on the planet, harboring over 650 species catalogued over decades of ornithological research across the entire biome. Our scientific survey conducted by ornithologist João Andriola in May 2024 recorded 166 distinct species in the immediate surroundings of the lodge in just 5 days of systematic fieldwork, demonstrating the exceptional density of avifauna in this area. The Santo Antônio do Leverger region, where Itaicy is located, is considered one of the highest bird concentration points in the Northern Pantanal due to the convergence of diverse habitats such as riparian forests, floodable fields, bays, and channels. Depending on the season, this number can increase with the arrival of migratory species from the northern hemisphere between October and December, further elevating the richness and diversity observable during your stay.",
      },
      {
        id: "bird-2",
        number: "02",
